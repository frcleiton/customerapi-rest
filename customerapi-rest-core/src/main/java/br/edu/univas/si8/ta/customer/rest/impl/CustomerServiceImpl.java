...
public class CustomerServiceImpl implements CustomerService{
	...
	@EJB(mappedName="java:app/customerapi-rest-ejb-0.1-SNAPSHOT/CustomerBean!br.edu.univas.si8.ta.customer.ejb.interfaces.CustomerRemote")
	...
	public String getCustomerById(int id) {
		return customer.getNameById(id);
	}
